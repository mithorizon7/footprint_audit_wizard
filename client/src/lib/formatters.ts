...
export function formatDuration(totalSeconds: number, _locale: Locale): string {
...
export const pluralMessages = {
  ...
  ru: {
    trackers:
      '{count, plural, =0 {нет трекеров} one {# трекер} few {# трекера} many {# трекеров} other {# трекеров}}',
    pages:
      '{count, plural, =0 {нет страниц} one {# страница} few {# страницы} many {# страниц} other {# страниц}}',
    sites:
      '{count, plural, =0 {нет сайтов} one {# сайт} few {# сайта} many {# сайтов} other {# сайтов}}',
    minutes:
      '{count, plural, =0 {0 минут} one {# минута} few {# минуты} many {# минут} other {# минут}}',
    seconds:
      '{count, plural, =0 {0 секунд} one {# секунда} few {# секунды} many {# секунд} other {# секунд}}',
    items:
      '{count, plural, =0 {нет элементов} one {# элемент} few {# элемента} many {# элементов} other {# элементов}}',
    actions:
      '{count, plural, =0 {нет действий} one {# действие} few {# действия} many {# действий} other {# действий}}',
    stepOf: 'Шаг {current} из {total}',
    targetMinutes:
      'Цель: {count, plural, one {# минута} few {# минуты} many {# минут} other {# минут}}',
